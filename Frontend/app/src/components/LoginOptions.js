...
const LoginOptions = () => {
  return (
    ...
    <NavLink  to ="/student/login" > <button id="studentButton" style={{ marginRight: '30%' }}>Student</button></NavLink>
    <NavLink  to ="/faculty/login" >  <button id="staffButton">Staff</button> </NavLink>
